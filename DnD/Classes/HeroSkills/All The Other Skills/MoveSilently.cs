...
namespace DnD.Classes.HeroSkills
{
    ...
    public class MoveSilently : BaseSkill
    {
        ...
        /// <summary>
        /// Represents the number of ranks the player has alloted into MoveSilently.
        /// </summary>
        public override int NumberOfRanks { get; set; }

        /// <summary>
        /// Returns the associated <see cref="Skills"/> MoveSilently is.
        /// </summary>
        public override Skills SkillType => Skills.MoveSilently;
    }
}
