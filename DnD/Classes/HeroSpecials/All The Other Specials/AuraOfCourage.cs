...
{
    /// <summary>
    /// The AuraOfCourage Special.
    /// </summary>
    public class AuraOfCourage : BaseSpecial, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// The minimum class level required for the ability to acquire AuraOfCourage.
        /// </summary>
        ...
        /// </summary>
        public string Description => UserStrings.SpecialStrings.AuraOfCourage;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassSpecial? SpecialType => ClassSpecial.AuraOfCourage;
    }
}
