...
{
    /// <summary>
    /// The WholenessOfBody Special.
    /// </summary>
    public class WholenessOfBody : BaseSpecial, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// The minimum class level required for the ability to acquire WholenessOfBody.
        /// </summary>
        ...
        /// </summary>
        public string Description => UserStrings.SpecialStrings.WholenessOfBody;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassSpecial? SpecialType => ClassSpecial.WholenessOfBody;
    }
}
