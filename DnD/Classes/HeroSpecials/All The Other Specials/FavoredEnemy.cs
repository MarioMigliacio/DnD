...
{
    /// <summary>
    /// The FavoredEnemy Special.
    /// </summary>
    public class FavoredEnemy : BaseSpecial, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// The minimum class level required for the ability to acquire FavoredEnemy.
        /// </summary>
        ...
        /// </summary>
        public string Description => UserStrings.SpecialStrings.FavoredEnemy;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassSpecial? SpecialType => ClassSpecial.FavoredEnemy;
    }
}
