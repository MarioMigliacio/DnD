...
{
    /// <summary>
    /// The InspireCourage Special.
    /// </summary>
    public class InspireCourage : BaseSpecial, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// The minimum class level required for the ability to acquire InspireCourage.
        /// </summary>
        ...
        /// </summary>
        public string Description => UserStrings.SpecialStrings.InspireCourage;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassSpecial? SpecialType => ClassSpecial.InspireCourage;
    }
}
