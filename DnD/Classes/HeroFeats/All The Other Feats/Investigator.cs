...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class Investigator : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Investigator feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Investigator feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Investigator;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Investigator;
    }
}
