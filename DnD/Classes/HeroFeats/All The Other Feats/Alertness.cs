...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Alertness Feat.
    /// </summary>
    public class Alertness : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Alertness feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Alertness feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Alertness;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Alertness;
    }
}
