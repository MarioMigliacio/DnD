...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The DeftHands Feat.
    /// </summary>
    public class DeftHands : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the DeftHands feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the DeftHands feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.DeftHands;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.DeftHands;
    }
}
