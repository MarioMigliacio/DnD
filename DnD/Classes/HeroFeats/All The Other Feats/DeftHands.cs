...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The DeftHands Feat.
    /// </summary>
    public class DeftHands : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.DeftHands;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.DeftHands;
    }
}
