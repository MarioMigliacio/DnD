...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The ForgeRing Feat.
    /// </summary>
    public class ForgeRing : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ForgeRing;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ForgeRing;
    }
}
