...
{
    /// <summary>
    /// The GreaterSpellFocus Feat.
    /// </summary>
    public class GreaterSpellFocus : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the GreaterSpellFocus feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the GreaterSpellFocus feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreaterSpellFocus;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreaterSpellFocus;
    }
}
