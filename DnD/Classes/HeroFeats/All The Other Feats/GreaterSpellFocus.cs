...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class GreaterSpellFocus : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.GreaterSpellFocus;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.GreaterSpellFocus;
    }
}
