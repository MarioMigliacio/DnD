...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedTrip : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedTrip;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedTrip;
    }
}
