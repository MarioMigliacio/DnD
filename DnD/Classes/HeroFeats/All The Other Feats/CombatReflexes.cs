...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class CombatReflexes : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.CombatReflexes;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.CombatReflexes;
    }
}
