...
{
    /// <summary>
    /// The CombatReflexes Feat.
    /// </summary>
    public class CombatReflexes : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the CombatReflexes feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the CombatReflexes feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CombatReflexes;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CombatReflexes;
    }
}
