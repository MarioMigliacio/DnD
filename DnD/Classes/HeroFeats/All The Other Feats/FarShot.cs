...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The FarShot Feat.
    /// </summary>
    public class FarShot : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the FarShot feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the FarShot feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.FarShot;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.FarShot;
    }
}
