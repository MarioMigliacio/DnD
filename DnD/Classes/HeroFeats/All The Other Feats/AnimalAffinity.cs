...
{
    /// <summary>
    /// The AnimalAffinity Feat.
    /// </summary>
    public class AnimalAffinity : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the AnimalAffinity feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the AnimalAffinity feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.AnimalAffinity;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.AnimalAffinity;
    }
}
