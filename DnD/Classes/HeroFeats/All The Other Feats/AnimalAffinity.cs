...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class AnimalAffinity : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.AnimalAffinity;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.AnimalAffinity;
    }
}
