...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Endurance Feat.
    /// </summary>
    public class Endurance : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Endurance feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Endurance feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Endurance;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Endurance;
    }
}
