...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Endurance Feat.
    /// </summary>
    public class Endurance : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Endurance;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Endurance;
    }
}
