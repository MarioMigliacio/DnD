...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class RideByAttack : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.RideByAttack;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.RideByAttack;
    }
}
