...
{
    /// <summary>
    /// The RideByAttack Feat.
    /// </summary>
    public class RideByAttack : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the RideByAttack feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the RideByAttack feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.RideByAttack;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.RideByAttack;
    }
}
