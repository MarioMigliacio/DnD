...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Stealthy Feat.
    /// </summary>
    public class Stealthy : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Stealthy feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Stealthy feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Stealthy;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Stealthy;
    }
}
