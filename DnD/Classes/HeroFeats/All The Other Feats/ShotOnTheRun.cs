...
{
    /// <summary>
    /// The ShotOnTheRun Feat.
    /// </summary>
    public class ShotOnTheRun : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ShotOnTheRun feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => 4;

        /// <summary>
        /// Returns the associated List of required Feats that the ShotOnTheRun feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new Dodge(), new Mobility(), new PointBlankShot()};
        ...
        /// </summary>
        public override KeyValuePair<Stats, int>? MinimumRequiredStat => new KeyValuePair<Stats, int>(Stats.Dexterity, 13);

        /// <summary>
        /// The associated Description tag for the string, found within the respective UserStrings files.
        /// </summary>
        public string Description => UserStrings.FeatStrings.ShotOnTheRun;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ShotOnTheRun;
    }
}
