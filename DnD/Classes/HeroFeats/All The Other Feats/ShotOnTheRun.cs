...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ShotOnTheRun : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ShotOnTheRun;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ShotOnTheRun;
    }
}
