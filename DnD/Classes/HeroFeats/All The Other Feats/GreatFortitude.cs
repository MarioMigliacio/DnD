...
{
    /// <summary>
    /// The GreatFortitude Feat.
    /// </summary>
    public class GreatFortitude : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the GreatFortitude feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the GreatFortitude feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreatFortitude;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreatFortitude;
    }
}
