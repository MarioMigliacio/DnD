...
{
    /// <summary>
    /// The PreciseShot Feat.
    /// </summary>
    public class PreciseShot : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the PreciseShot feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the PreciseShot feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.PreciseShot;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.PreciseShot;
    }
}
