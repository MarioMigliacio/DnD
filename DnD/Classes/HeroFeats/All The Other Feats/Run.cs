...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Run Feat.
    /// </summary>
    public class Run : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Run feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Run feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Run;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Run;
    }
}
