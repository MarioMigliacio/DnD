...
{
    /// <summary>
    /// The SimpleWeaponProficiency Feat.
    /// </summary>
    public class SimpleWeaponProficiency : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the SimpleWeaponProficiency feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the SimpleWeaponProficiency feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SimpleWeaponProficiency;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SimpleWeaponProficiency;
    }
}
