...
{
    /// <summary>
    /// The CraftWondrousItem Feat.
    /// </summary>
    public class CraftWondrousItem : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the CraftWondrousItem feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the CraftWondrousItem feat requires.
        ...
        /// </summary>
        public override BaseCharacterClass ClassLevelPrerequisites => new Caster {ClassLevel = 3};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CraftWondrousItem;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CraftWondrousItem;
    }
}
