...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class CraftWondrousItem : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.CraftWondrousItem;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.CraftWondrousItem;
    }
}
