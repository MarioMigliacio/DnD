...
{
    /// <summary>
    /// The WeaponFocus Feat.
    /// </summary>
    public class WeaponFocus : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the WeaponFocus feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => 1;

        /// <summary>
        /// Returns the associated List of required Feats that the WeaponFocus feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.WeaponFocus;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.WeaponFocus;
    }
}
