...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class WeaponFocus : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.WeaponFocus;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.WeaponFocus;
    }
}
