...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Manyshot Feat.
    /// </summary>
    public class Manyshot : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Manyshot;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Manyshot;
    }
}
