...
{
    /// <summary>
    /// The GreaterSpellPenetration Feat.
    /// </summary>
    public class GreaterSpellPenetration : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the GreaterSpellPenetration feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the GreaterSpellPenetration feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new SpellPenetration()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreaterSpellPenetration;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreaterSpellPenetration;
    }
}
