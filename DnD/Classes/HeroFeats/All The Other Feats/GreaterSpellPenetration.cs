...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class GreaterSpellPenetration : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.GreaterSpellPenetration;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.GreaterSpellPenetration;
    }
}
