...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The CraftRod Feat.
    /// </summary>
    public class CraftRod : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CraftRod;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CraftRod;
    }
}
