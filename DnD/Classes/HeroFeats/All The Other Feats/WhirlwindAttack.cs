...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class WhirlwindAttack : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.WhirlwindAttack;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.WhirlwindAttack;
    }
}
