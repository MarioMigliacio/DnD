...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class StunningFist : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.StunningFist;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.StunningFist;
    }
}
