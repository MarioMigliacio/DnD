...
{
    /// <summary>
    /// The ImprovedTurning Feat.
    /// </summary>
    public class ImprovedTurning : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedTurning feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedTurning feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedTurning;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedTurning;
    }
}
