...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class GreaterWeaponSpecialization : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreaterWeaponSpecialization;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreaterWeaponSpecialization;
    }
}
