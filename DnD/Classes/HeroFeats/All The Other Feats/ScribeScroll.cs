...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ScribeScroll : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ScribeScroll;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ScribeScroll;
    }
}
