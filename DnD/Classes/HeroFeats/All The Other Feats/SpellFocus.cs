...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The SpellFocus Feat.
    /// </summary>
    public class SpellFocus : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.SpellFocus;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.SpellFocus;
    }
}
