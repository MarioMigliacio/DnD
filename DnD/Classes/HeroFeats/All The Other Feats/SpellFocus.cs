...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The SpellFocus Feat.
    /// </summary>
    public class SpellFocus : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the SpellFocus feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the SpellFocus feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SpellFocus;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SpellFocus;
    }
}
