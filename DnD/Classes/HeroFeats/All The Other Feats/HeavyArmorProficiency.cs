...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class HeavyArmorProficiency : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.HeavyArmorProficiency;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.HeavyArmorProficiency;
    }
}
