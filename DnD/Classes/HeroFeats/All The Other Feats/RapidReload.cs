...
{
    /// <summary>
    /// The RapidReload Feat.
    /// </summary>
    public class RapidReload : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the RapidReload feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the RapidReload feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.RapidReload;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.RapidReload;
    }
}
