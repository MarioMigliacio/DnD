...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class RapidReload : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.RapidReload;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.RapidReload;
    }
}
