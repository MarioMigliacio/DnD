...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Track Feat.
    /// </summary>
    public class Track : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Track feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Track feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Track;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Track;
    }
}
