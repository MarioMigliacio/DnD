...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class WeaponFinesse : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.WeaponFinesse;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.WeaponFinesse;
    }
}
