...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ExoticWeaponProficiency : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ExoticWeaponProficiency;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ExoticWeaponProficiency;
    }
}
