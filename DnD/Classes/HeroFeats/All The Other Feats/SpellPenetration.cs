...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class SpellPenetration : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.SpellPenetration;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.SpellPenetration;
    }
}
