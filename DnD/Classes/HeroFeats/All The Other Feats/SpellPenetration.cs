...
{
    /// <summary>
    /// The SpellPenetration Feat.
    /// </summary>
    public class SpellPenetration : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the SpellPenetration feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the SpellPenetration feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SpellPenetration;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SpellPenetration;
    }
}
