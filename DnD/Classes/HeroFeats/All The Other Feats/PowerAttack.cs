...
{
    /// <summary>
    /// The PowerAttack Feat.
    /// </summary>
    public class PowerAttack : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the PowerAttack feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the PowerAttack feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.PowerAttack;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.PowerAttack;
    }
}
