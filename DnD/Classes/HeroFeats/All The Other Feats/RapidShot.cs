...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The RapidShot Feat.
    /// </summary>
    public class RapidShot : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the RapidShot feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the RapidShot feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new PointBlankShot()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.RapidShot;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.RapidShot;
    }
}
