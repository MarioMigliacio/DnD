...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class SilentSpell : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.SilentSpell;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.SilentSpell;
    }
}
