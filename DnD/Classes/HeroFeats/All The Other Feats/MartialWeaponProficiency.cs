...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class MartialWeaponProficiency : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.MartialWeaponProficiency;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.MartialWeaponProficiency;
    }
}
