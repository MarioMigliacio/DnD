...
{
    /// <summary>
    /// The MartialWeaponProficiency Feat.
    /// </summary>
    public class MartialWeaponProficiency : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the MartialWeaponProficiency feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the MartialWeaponProficiency feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.MartialWeaponProficiency;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.MartialWeaponProficiency;
    }
}
