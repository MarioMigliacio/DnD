...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class MaximizeSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.MaximizeSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.MaximizeSpell;
    }
}
