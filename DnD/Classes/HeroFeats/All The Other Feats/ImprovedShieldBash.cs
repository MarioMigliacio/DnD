...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedShieldBash : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ImprovedShieldBash;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ImprovedShieldBash;
    }
}
