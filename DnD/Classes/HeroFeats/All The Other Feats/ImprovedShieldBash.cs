...
{
    /// <summary>
    /// The ImprovedShieldBash Feat.
    /// </summary>
    public class ImprovedShieldBash : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedShieldBash feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedShieldBash feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedShieldBash;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedShieldBash;
    }
}
