...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Persuasive Feat.
    /// </summary>
    public class Persuasive : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Persuasive;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Persuasive;
    }
}
