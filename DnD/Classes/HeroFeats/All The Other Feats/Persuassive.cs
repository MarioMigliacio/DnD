...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Persuasive Feat.
    /// </summary>
    public class Persuasive : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Persuasive feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Persuasive feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Persuasive;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Persuasive;
    }
}
