...
{
    /// <summary>
    /// The WeaponSpecialization Feat.
    /// </summary>
    public class WeaponSpecialization : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the WeaponSpecialization feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the WeaponSpecialization feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new WeaponFocus()};

        /// <summary>
        /// Returns a Class type with a Level if there is a required Class restriction on this feat.
        /// </summary>
        public override BaseCharacterClass ClassLevelPrerequisites => new Fighter {ClassLevel = 4};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.WeaponSpecialization;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.WeaponSpecialization;
    }
}
