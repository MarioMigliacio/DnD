...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class SpellMastery : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.SpellMastery;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.SpellMastery;
    }
}
