...
{
    /// <summary>
    /// The SpellMastery Feat.
    /// </summary>
    public class SpellMastery : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the SpellMastery feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the SpellMastery feat requires.
        ...
        /// </summary>
        public override BaseCharacterClass ClassLevelPrerequisites => new Wizard {ClassLevel = 1};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SpellMastery;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SpellMastery;
    }
}
