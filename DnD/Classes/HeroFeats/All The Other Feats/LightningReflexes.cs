...
{
    /// <summary>
    /// The LightningReflexes Feat.
    /// </summary>
    public class LightningReflexes : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the LightningReflexes feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the LightningReflexes feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.LightningReflexes;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.LightningReflexes;
    }
}
