...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class LightningReflexes : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.LightningReflexes;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.LightningReflexes;
    }
}
