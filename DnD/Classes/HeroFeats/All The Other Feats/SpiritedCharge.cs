...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class SpiritedCharge : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.SpiritedCharge;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.SpiritedCharge;
    }
}
