...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The SkillFocus Feat.
    /// </summary>
    public class SkillFocus : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the SkillFocus feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the SkillFocus feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SkillFocus;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SkillFocus;
    }
}
