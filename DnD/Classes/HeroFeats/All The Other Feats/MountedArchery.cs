...
{
    /// <summary>
    /// The MountedArchery Feat.
    /// </summary>
    public class MountedArchery : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the MountedArchery feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the MountedArchery feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new MountedCombat()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.MountedArchery;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.MountedArchery;
    }
}
