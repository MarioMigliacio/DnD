...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The CraftStaff Feat.
    /// </summary>
    public class CraftStaff : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.CraftStaff;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.CraftStaff;
    }
}
