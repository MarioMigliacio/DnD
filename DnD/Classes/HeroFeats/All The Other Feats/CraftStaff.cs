...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The CraftStaff Feat.
    /// </summary>
    public class CraftStaff : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the CraftStaff feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the CraftStaff feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CraftStaff;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CraftStaff;
    }
}
