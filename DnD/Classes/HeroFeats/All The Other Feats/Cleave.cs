...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Cleave Feat.
    /// </summary>
    public class Cleave : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Cleave feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Cleave feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Cleave;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Cleave;
    }
}
