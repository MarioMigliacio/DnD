...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class EschewMaterials : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.EschewMaterials;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.EschewMaterials;
    }
}
