...
{
    /// <summary>
    /// The EschewMaterials Feat.
    /// </summary>
    public class EschewMaterials : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the EschewMaterials feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the EschewMaterials feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.EschewMaterials;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.EschewMaterials;
    }
}
