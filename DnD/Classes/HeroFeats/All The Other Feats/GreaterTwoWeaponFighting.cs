...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class GreaterTwoWeaponFighting : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreaterTwoWeaponFighting;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreaterTwoWeaponFighting;
    }
}
