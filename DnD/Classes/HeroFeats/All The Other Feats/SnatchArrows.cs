...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class SnatchArrows : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SnatchArrows;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SnatchArrows;
    }
}
