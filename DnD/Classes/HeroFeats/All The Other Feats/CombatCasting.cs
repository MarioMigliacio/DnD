...
{
    /// <summary>
    /// The CombatCasting Feat.
    /// </summary>
    public class CombatCasting : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the CombatCasting feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the CombatCasting feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CombatCasting;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CombatCasting;
    }
}
