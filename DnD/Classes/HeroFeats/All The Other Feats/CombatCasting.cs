...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class CombatCasting : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.CombatCasting;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.CombatCasting;
    }
}
