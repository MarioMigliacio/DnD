...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class TowerShieldProficiency : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.TowerShieldProficiency;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.TowerShieldProficiency;
    }
}
