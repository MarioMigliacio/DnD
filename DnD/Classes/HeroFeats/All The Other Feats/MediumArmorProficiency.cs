...
{
    /// <summary>
    /// The MediumArmorProficiency Feat.
    /// </summary>
    public class MediumArmorProficiency : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the MediumArmorProficiency feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the MediumArmorProficiency feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new LightArmorProficiency()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.MediumArmorProficiency;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.MediumArmorProficiency;
    }
}
