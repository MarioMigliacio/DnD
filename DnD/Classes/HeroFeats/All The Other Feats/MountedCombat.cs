...
{
    /// <summary>
    /// The MountedCombat Feat.
    /// </summary>
    public class MountedCombat : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the MountedCombat feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the MountedCombat feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.MountedCombat;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.MountedCombat;
    }
}
