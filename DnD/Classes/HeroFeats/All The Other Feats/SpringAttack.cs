...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class SpringAttack : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.SpringAttack;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.SpringAttack;
    }
}
