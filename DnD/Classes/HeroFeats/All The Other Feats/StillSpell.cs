...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The StillSpell Feat.
    /// </summary>
    public class StillSpell : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.StillSpell;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.StillSpell;
    }
}
