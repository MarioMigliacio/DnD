...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The StillSpell Feat.
    /// </summary>
    public class StillSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the StillSpell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the StillSpell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.StillSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.StillSpell;
    }
}
