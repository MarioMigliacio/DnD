...
{
    /// <summary>
    /// The QuickenSpell Feat.
    /// </summary>
    public class QuickenSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the QuickenSpell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the QuickenSpell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.QuickenSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.QuickenSpell;
    }
}
