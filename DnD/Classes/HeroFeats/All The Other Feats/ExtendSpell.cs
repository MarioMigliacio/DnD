...
{
    /// <summary>
    /// The ExtendSpell Feat.
    /// </summary>
    public class ExtendSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ExtendSpell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ExtendSpell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ExtendSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ExtendSpell;
    }
}
