...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Mobility Feat.
    /// </summary>
    public class Mobility : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Mobility;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Mobility;
    }
}
