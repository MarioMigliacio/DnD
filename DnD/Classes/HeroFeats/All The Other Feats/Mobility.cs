...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Mobility Feat.
    /// </summary>
    public class Mobility : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Mobility feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Mobility feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new Dodge()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Mobility;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Mobility;
    }
}
