...
{
    /// <summary>
    /// The EnlargeSpell Feat.
    /// </summary>
    public class EnlargeSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the EnlargeSpell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the EnlargeSpell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.EnlargeSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.EnlargeSpell;
    }
}
