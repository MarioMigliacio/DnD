...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Diehard Feat.
    /// </summary>
    public class Diehard : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Diehard feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Diehard feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new Endurance()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Diehard;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Diehard;
    }
}
