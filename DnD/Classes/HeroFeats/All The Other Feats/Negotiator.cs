...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Negotiator Feat.
    /// </summary>
    public class Negotiator : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Negotiator feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Negotiator feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Negotiator;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Negotiator;
    }
}
