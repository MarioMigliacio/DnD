...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Negotiator Feat.
    /// </summary>
    public class Negotiator : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Negotiator;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Negotiator;
    }
}
