...
{
    /// <summary>
    /// The GreaterWeaponFocus Feat.
    /// </summary>
    public class GreaterWeaponFocus : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the GreaterWeaponFocus feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the GreaterWeaponFocus feat requires.
        ...
        /// </summary>
        public override BaseCharacterClass ClassLevelPrerequisites => new Fighter {ClassLevel = 8};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreaterWeaponFocus;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreaterWeaponFocus;
    }
}
