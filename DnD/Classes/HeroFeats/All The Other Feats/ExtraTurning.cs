...
{
    /// <summary>
    /// The ExtraTurning Feat.
    /// </summary>
    public class ExtraTurning : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ExtraTurning feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ExtraTurning feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ExtraTurning;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ExtraTurning;
    }
}
