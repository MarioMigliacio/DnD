...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ExtraTurning : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ExtraTurning;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ExtraTurning;
    }
}
