...
{
    /// <summary>
    /// The ImprovedUnarmedStrike Feat.
    /// </summary>
    public class ImprovedUnarmedStrike : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedUnarmedStrike feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedUnarmedStrike feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedUnarmedStrike;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedUnarmedStrike;
    }
}
