...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedUnarmedStrike : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ImprovedUnarmedStrike;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ImprovedUnarmedStrike;
    }
}
