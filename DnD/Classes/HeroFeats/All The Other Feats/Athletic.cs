...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Athletic Feat.
    /// </summary>
    public class Athletic : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Athletic feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Athletic feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Athletic;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Athletic;
    }
}
