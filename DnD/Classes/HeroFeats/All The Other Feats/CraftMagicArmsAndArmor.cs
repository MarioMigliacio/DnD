...
{
    /// <summary>
    /// The CraftMagicArmsAndArmor Feat.
    /// </summary>
    public class CraftMagicArmsAndArmor : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the CraftMagicArmsAndArmor feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the CraftMagicArmsAndArmor feat requires.
        ...
        /// </summary>
        public override BaseCharacterClass ClassLevelPrerequisites => new Caster {ClassLevel = 5};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CraftMagicArmsAndArmor;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CraftMagicArmsAndArmor;
    }
}
