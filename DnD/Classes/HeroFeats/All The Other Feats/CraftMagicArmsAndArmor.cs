...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class CraftMagicArmsAndArmor : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.CraftMagicArmsAndArmor;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.CraftMagicArmsAndArmor;
    }
}
