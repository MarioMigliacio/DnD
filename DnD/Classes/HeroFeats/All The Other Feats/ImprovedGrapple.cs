...
{
    /// <summary>
    /// The ImprovedGrapple Feat.
    /// </summary>
    public class ImprovedGrapple : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedGrapple feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedGrapple feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedGrapple;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedGrapple;
    }
}
