...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedGrapple : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ImprovedGrapple;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ImprovedGrapple;
    }
}
