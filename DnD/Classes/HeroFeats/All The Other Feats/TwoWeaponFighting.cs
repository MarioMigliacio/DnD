...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class TwoWeaponFighting : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.TwoWeaponFighting;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.TwoWeaponFighting;
    }
}
