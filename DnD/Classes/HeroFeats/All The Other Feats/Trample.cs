...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Trample Feat.
    /// </summary>
    public class Trample : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Trample feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Trample feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Trample;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Trample;
    }
}
