...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedCritical : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ImprovedCritical;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ImprovedCritical;
    }
}
