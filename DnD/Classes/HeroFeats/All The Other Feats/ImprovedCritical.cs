...
{
    /// <summary>
    /// The ImprovedCritical Feat.
    /// </summary>
    public class ImprovedCritical : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedCritical feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => 8;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedCritical feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedCritical;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedCritical;
    }
}
