...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The IronWill Feat.
    /// </summary>
    public class IronWill : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.IronWill;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.IronWill;
    }
}
