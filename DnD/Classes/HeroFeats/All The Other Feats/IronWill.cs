...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The IronWill Feat.
    /// </summary>
    public class IronWill : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the IronWill feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the IronWill feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.IronWill;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.IronWill;
    }
}
