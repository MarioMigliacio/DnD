...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The WidenSpell Feat.
    /// </summary>
    public class WidenSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the WidenSpell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the WidenSpell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.WidenSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.WidenSpell;
    }
}
