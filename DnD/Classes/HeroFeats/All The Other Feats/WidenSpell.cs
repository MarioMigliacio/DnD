...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The WidenSpell Feat.
    /// </summary>
    public class WidenSpell : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.WidenSpell;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.WidenSpell;
    }
}
