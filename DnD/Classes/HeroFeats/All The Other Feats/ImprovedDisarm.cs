...
{
    /// <summary>
    /// The ImprovedDisarm Feat.
    /// </summary>
    public class ImprovedDisarm : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedDisarm feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedDisarm feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedDisarm;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedDisarm;
    }
}
