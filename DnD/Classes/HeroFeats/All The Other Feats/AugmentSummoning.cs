...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class AugmentSummoning : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.AugmentSummoning;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.AugmentSummoning;
    }
}
