...
{
    /// <summary>
    /// The AugmentSummoning Feat.
    /// </summary>
    public class AugmentSummoning : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the AugmentSummoning feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the AugmentSummoning feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new SpellFocus()};
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.AugmentSummoning;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.AugmentSummoning;
    }
}
