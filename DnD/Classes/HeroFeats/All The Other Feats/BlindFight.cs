...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The BlindFight Feat.
    /// </summary>
    public class BlindFight : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the BlindFight feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the BlindFight feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.BlindFight;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.BlindFight;
    }
}
