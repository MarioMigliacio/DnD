...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The BlindFight Feat.
    /// </summary>
    public class BlindFight : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.BlindFight;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.BlindFight;
    }
}
