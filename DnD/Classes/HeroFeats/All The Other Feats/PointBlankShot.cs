...
{
    /// <summary>
    /// The PointBlankShot Feat.
    /// </summary>
    public class PointBlankShot : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the PointBlankShot feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the PointBlankShot feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.PointBlankShot;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.PointBlankShot;
    }
}
