...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class PointBlankShot : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.PointBlankShot;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.PointBlankShot;
    }
}
