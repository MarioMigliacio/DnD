...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class GreatCleave : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.GreatCleave;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.GreatCleave;
    }
}
