...
{
    /// <summary>
    /// The GreatCleave Feat.
    /// </summary>
    public class GreatCleave : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the GreatCleave feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => 4;

        /// <summary>
        /// Returns the associated List of required Feats that the GreatCleave feat requires.
        /// Null if no required Feats.
        /// </summary>
        public override List<BaseFeat> FeatPrerequisites => new List<BaseFeat> {new PowerAttack(), new Cleave()};
        ...
        /// </summary>
        public override KeyValuePair<Stats, int>? MinimumRequiredStat => new KeyValuePair<Stats, int>(Stats.Strength, 13);

        /// <summary>
        /// The associated Description tag for the string, found within the respective UserStrings files.
        /// </summary>
        public string Description => UserStrings.FeatStrings.GreatCleave;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.GreatCleave;
    }
}
