...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Toughness Feat.
    /// </summary>
    public class Toughness : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Toughness;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Toughness;
    }
}
