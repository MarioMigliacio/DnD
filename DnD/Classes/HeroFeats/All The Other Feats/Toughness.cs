...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Toughness Feat.
    /// </summary>
    public class Toughness : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Toughness feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Toughness feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Toughness;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Toughness;
    }
}
