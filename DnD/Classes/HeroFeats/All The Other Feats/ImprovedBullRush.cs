...
{
    /// <summary>
    /// The ImprovedBullRush Feat.
    /// </summary>
    public class ImprovedBullRush : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedBullRush feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedBullRush feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedBullRush;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedBullRush;
    }
}
