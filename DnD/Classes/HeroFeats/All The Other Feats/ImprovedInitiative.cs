...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedInitiative : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedInitiative;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedInitiative;
    }
}
