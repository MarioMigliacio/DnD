...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedOverrun : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedOverrun;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedOverrun;
    }
}
