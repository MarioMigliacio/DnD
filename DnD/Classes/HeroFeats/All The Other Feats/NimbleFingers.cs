...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class NimbleFingers : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.NimbleFingers;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.NimbleFingers;
    }
}
