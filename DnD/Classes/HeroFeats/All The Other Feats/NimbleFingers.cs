...
{
    /// <summary>
    /// The NimbleFingers Feat.
    /// </summary>
    public class NimbleFingers : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the NimbleFingers feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the NimbleFingers feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.NimbleFingers;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.NimbleFingers;
    }
}
