...
{
    /// <summary>
    /// The MagicalAptitude Feat.
    /// </summary>
    public class MagicalAptitude : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the MagicalAptitude feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the MagicalAptitude feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.MagicalAptitude;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.MagicalAptitude;
    }
}
