...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedSunder : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ImprovedSunder;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ImprovedSunder;
    }
}
