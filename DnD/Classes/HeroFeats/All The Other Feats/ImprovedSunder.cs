...
{
    /// <summary>
    /// The ImprovedSunder Feat.
    /// </summary>
    public class ImprovedSunder : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedSunder feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedSunder feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedSunder;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedSunder;
    }
}
