...
{
    /// <summary>
    /// The LightArmorProficiency Feat.
    /// </summary>
    public class LightArmorProficiency : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the LightArmorProficiency feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the LightArmorProficiency feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.LightArmorProficiency;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.LightArmorProficiency;
    }
}
