...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class LightArmorProficiency : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.LightArmorProficiency;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.LightArmorProficiency;
    }
}
