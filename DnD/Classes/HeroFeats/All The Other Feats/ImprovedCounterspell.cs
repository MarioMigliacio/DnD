...
{
    /// <summary>
    /// The ImprovedCounterspell Feat.
    /// </summary>
    public class ImprovedCounterspell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the ImprovedCounterspell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the ImprovedCounterspell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ImprovedCounterspell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ImprovedCounterspell;
    }
}
