...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ImprovedCounterspell : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.ImprovedCounterspell;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.ImprovedCounterspell;
    }
}
