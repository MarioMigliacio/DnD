...
{
    /// <summary>
    /// The EmpowerSpell Feat.
    /// </summary>
    public class EmpowerSpell : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the EmpowerSpell feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the EmpowerSpell feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.EmpowerSpell;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.EmpowerSpell;
    }
}
