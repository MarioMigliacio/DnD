...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class EmpowerSpell : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.EmpowerSpell;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.EmpowerSpell;
    }
}
