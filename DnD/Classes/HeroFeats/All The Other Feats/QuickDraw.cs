...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Quickdraw Feat.
    /// </summary>
    public class Quickdraw : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Quickdraw;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Quickdraw;
    }
}
