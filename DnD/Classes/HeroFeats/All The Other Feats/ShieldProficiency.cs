...
namespace DnD.Classes.HeroFeats
{
    ...
    /// </summary>
    public class ShieldProficiency : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.ShieldProficiency;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.ShieldProficiency;
    }
}
