...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The BrewPotion Feat.
    /// </summary>
    public class BrewPotion : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.BrewPotion;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.BrewPotion;
    }
}
