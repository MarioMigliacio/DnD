...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The BrewPotion Feat.
    /// </summary>
    public class BrewPotion : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the BrewPotion feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the BrewPotion feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.BrewPotion;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.BrewPotion;
    }
}
