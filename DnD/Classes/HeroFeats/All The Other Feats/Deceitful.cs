...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Deceitful Feat.
    /// </summary>
    public class Deceitful : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Deceitful;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Deceitful;
    }
}
