...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Deceitful Feat.
    /// </summary>
    public class Deceitful : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Deceitful feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Deceitful feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Deceitful;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Deceitful;
    }
}
