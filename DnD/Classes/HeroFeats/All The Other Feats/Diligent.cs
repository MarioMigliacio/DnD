...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Diligent Feat.
    /// </summary>
    public class Diligent : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.Diligent;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.Diligent;
    }
}
