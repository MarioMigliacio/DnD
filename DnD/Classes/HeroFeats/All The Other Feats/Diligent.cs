...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Diligent Feat.
    /// </summary>
    public class Diligent : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Diligent feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Diligent feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Diligent;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Diligent;
    }
}
