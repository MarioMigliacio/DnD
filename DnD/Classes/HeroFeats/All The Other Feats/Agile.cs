...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The Agile Feat.
    /// </summary>
    public class Agile : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the Agile feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the Agile feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.Agile;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.Agile;
    }
}
