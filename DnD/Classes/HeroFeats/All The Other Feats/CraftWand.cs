...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The CraftWand Feat.
    /// </summary>
    public class CraftWand : BaseFeat, IHeroSpecialSkillFeats
    {
        /// <summary>
        /// Returns the value of required base attack for the CraftWand feat.
        /// </summary>
        public override int? AttackBonusPrerequisites => null;

        /// <summary>
        /// Returns the associated List of required Feats that the CraftWand feat requires.
        ...
        /// </summary>
        public string Description => UserStrings.FeatStrings.CraftWand;
        ...
        /// Null if not compatable.
        /// </summary>
        public ClassFeats? FeatType => ClassFeats.CraftWand;
    }
}
