...
namespace DnD.Classes.HeroFeats
{
    ...
    /// The CraftWand Feat.
    /// </summary>
    public class CraftWand : BaseFeat
    {
        /// <summary>
        ...
        /// </summary>
        public override string Description => UserStrings.FeatStrings.CraftWand;

        /// <summary>
        /// Returns the enumeration type of Feat this particular Feat represents.
        /// </summary>
        public override ClassFeats FeatType => ClassFeats.CraftWand;
    }
}
